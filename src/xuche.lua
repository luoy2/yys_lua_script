...
function jiyang_nextpage(times)
	...
	for i = 1, times, 1 do
		...
		--local x, y = findMultiColorInRegionFuzzy(0x716f6d,"0|2|0xe4e4e4,0|5|0x5a5a5a,0|8|0x454545,0|12|0x29221a,-2|43|0x464646,0|49|0x7f7f7f,0|51|0xd7d7d7", 90, 568, 1185, 698, 1344)	if x > -1 then
		if x>-1 then	
			sysLog('底部')
			return i
		end
